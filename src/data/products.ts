...
export const productCategories: ProductCategory[] = [
  {
    ...
    icon: Building2,
    image: "/images/products/reception_logo_signage.png",
    subcategories: [
    ...
    items: [
      { name: "Reception Logo Signage", description: "Corporate Branding", image: "/images/products/reception_logo_signage.png" },
      { name: "Company Name Boards", description: "Corporate Branding" },
      { name: "Building Name Boards", description: "Corporate Branding" },
      { name: "Project Name Boards", description: "Corporate Branding" },
      { name: "Department Name Boards", description: "Corporate Branding" },
      { name: "Reception Desk Branding", description: "Corporate Branding" },
      { name: "Lobby Feature Wall Signage", description: "Corporate Branding" },
      { name: "3D Logo Installations", description: "Corporate Branding" },
      { name: "Corporate Tagline Signage", description: "Corporate Branding" },
      { name: "Mission/Vision Statement Walls", description: "Corporate Branding" },
      { name: "Room Name Plates", description: "Interior Identification" },
      { name: "Cabin Name Plates", description: "Interior Identification" },
      { name: "Conference Room Signage", description: "Interior Identification" },
      ...
      { name: "Server Room Signage", description: "Technical Identification" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Building Directory Signage", description: "Interior Navigation" },
      { name: "You-Are-Here Maps", description: "Interior Navigation" },
      { name: "Directional Arrow Signage", description: "Interior Navigation" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Hanging Aisle Signage", description: "Suspended" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "High Voltage Signage", description: "Hazard Warning" },
      ...
      { name: "PPE Instruction Signage", description: "PPE & Instructions" },
      ...
      { name: "No Smoking Signage", description: "Access & Prohibition" },
  ...
  },
  {
    ...
    items: [
      { name: "Fire Extinguisher Signage", description: "Fire Safety Equipment" },
      ...
      { name: "Emergency Exit Signage", description: "Emergency Response" },
      { name: "Evacuation Maps", description: "Emergency Response" },
      { name: "Evacuation Route Signage", description: "Emergency Response" },
      { name: "Assembly Point Signage", description: "Emergency Response" },
      ...
      { name: "First-Aid Signage", description: "Medical Emergency" },
  ...
  },
  {
    ...
    items: [
      { name: "Floor Safety Markings", description: "Safety Markings" },
  ...
  },
  {
    ...
    items: [
      { name: "Restroom Signage", description: "Common Area" },
      { name: "Cafeteria Signage", description: "Common Area" },
      ...
      { name: "Wi-Fi Signage", description: "Public Information" },
      ...
      { name: "Notice Boards", description: "Communication Boards" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Asset Tags", description: "Asset Management" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Light Box Frames", description: "Illuminated Displays" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Interactive Kiosks", description: "Interactive Digital" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Vinyl Wall Graphics", description: "Wall Graphics" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Monument Signage", description: "Building Exterior" },
      ...
      { name: "Visitor Parking Signage", description: "Parking" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Retractable Banners", description: "Event & Promotional" },
  ...
  },
  {
    ...
    items: [
      { name: "Waste Segregation Signage", description: "Waste Management" },
  ...
  },
  {
    ...
    items: [
      { name: "Sanitization Station Signage", description: "Sanitation" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Forklift Operating Area Signage", description: "Heavy Equipment" },
