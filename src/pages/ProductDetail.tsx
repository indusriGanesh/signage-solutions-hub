...
const ProductDetail = () => {
    ...
    useEffect(() => {
        ...
        // Since we don't have slugs in the data for items yet, we match by slugified name
        ...
        if (categorySlug) {
            ...
            // Fallback: search all categories if for some reason categorySlug isn't standard (though route requires it)
        ...
        if (foundProduct) {
            ...
            // navigate("/404"); // Or manage error state
        }
